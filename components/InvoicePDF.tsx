...
const styles = StyleSheet.create({
  ...
  totalBox: { flexDirection: 'row', backgroundColor: '#f4f4f4', padding: '15px 20px', borderRadius: 4, alignItems: 'center' },
  totalLabel: { fontSize: 13, fontWeight: 'bold', marginRight: 20 },
  totalAmount: { fontSize: 18, color: '#E31C25', fontWeight: 'bold' },
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.table}>
          <View style={styles.tableHeader}>
            ...
            <Text style={styles.tableHeaderCol2}>IMPORTE</Text>
          </View>
